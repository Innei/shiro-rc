...
import { getViewport } from '~/atoms/hooks/index.js'
import { AutoResizeHeight } from '~/components/shared/AutoResizeHeight.js'
import { useMaskScrollArea } from '~/hooks/shared/use-mask-scrollarea.js'
import { stopPropagation } from '~/lib/dom.js'
import { clsxm } from '~/lib/helper.js'

import { MotionButtonBase } from '../../button/index.js'
import styles from './Shiki.module.css'
import { parseFilenameFromAttrs } from './utils.js'
