...
import { FluentShieldError20Regular } from '~/components/icons/status.js'
...
import {
  ...
  RiMarkdownFill,
  UilReact,
} from '../../icons/Language.js'
import { CodeBlockWrapper } from './CodeBlockWrapper.js'
import { codeHighlighter } from './utils.js'
