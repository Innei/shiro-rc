import { BilibiliIcon } from '~/components/icons/platform/BilibiliIcon.js'
import { GitHubBrandIcon } from '~/components/icons/platform/GitHubBrandIcon.js'
import { CibMozilla } from '~/components/icons/platform/Moz.js'
import { VscodeIconsFileTypeNpm } from '~/components/icons/platform/NpmIcon.js'
import { IcBaselineTelegram } from '~/components/icons/platform/Telegram.js'
import { SimpleIconsThemoviedatabase } from '~/components/icons/platform/TheMovieDB.js'
import { TwitterIcon } from '~/components/icons/platform/Twitter.js'
import { WikipediaIcon } from '~/components/icons/platform/WikipediaIcon.js'
import { SimpleIconsZhihu } from '~/components/icons/platform/ZhihuIcon.js'
