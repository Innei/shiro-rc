  ...
  return (
    <>
      <html lang="en" suppressHydrationWarning>
        ...
        <body className={clsx("min-h-screen font-sans", GeistSans.className)}>
          <ThemeProvider>
                    ...
                    <div className="m-auto mt-24" id="layer">
                      ...
                      >
                        ...
                        <PresentSheet content={<LeftAside asWeight />}>
                          <button className="fixed bottom-4 right-4 z-10 block rounded-full border border-zinc-200 bg-white p-2 text-black shadow dark:border-zinc-800 dark:bg-gray-950 dark:text-white xl:hidden">
